            ...
            <div class="card">
                ...
                <div class="body">
	                <div class="table-responsive">
                        <br/>
	                    <table id="list-city" class="table table-bordered table-striped table-hover js-basic-example dataTable">
	                        <thead>
	                            <tr>
                                    <th>ID</th>
                                    <th>Nama</th>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="smallModalLabel">Hapus Kota</h4>
            </div>
